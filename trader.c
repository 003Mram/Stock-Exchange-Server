...
//     if(trader == NULL){
//         i = 0;
//         while(i<MAX_TRADERS && traders[i].fd != -1){
//             i++;
//         }
//         if(i<MAX_TRADERS){

//             debug("%ld: Create new trader %p [%s]", time(NULL), trader, name);
//             trader->fd = fd;
//             trader->name = name;
...
//         }
//     }else{
//         debug("%ld: Login existing trader %p [%s]",time(NULL), trader, name);
//         trader_ref(trader,"because trader has logged in");
//     }
